...
export default function Page() {
  return (
    <div>
      {/* No Transition */}
      <button className="px-8 py-2 m-24 text-white bg-blue-300 rounded hover:bg-blue-700">
        Click me
      </button>

      {/* Transition */}
      <button className="px-8 py-2 m-24 text-white bg-blue-300 rounded hover:bg-blue-700 transition-colors duration-500">
        Click me
      </button>

      {/* Transition & Transform */}
      <button className="px-8 py-2 m-24 text-white bg-blue-300 rounded hover:bg-blue-700 scale-150">
        Click me
      </button>
      <button className="px-8 py-2 m-24 text-white bg-blue-300 rounded hover:bg-blue-700 hover:rotate-12 transition-transform duration-500">
        Click me
      </button>
      <Image
