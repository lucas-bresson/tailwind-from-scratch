export default function Page() {
  return (
    <div>
      ...
      {/* Border Radius */}
      <div className="w-96 m-3 p-5 border-4 rounded border-red-500">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, nobis.
      </div>
      <div className="w-96 m-3 p-5 border-4 rounded-lg border-red-500">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, nobis.
      </div>
      <div className="w-96 m-3 p-5 border-4 rounded-2xl border-red-500">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, nobis.
      </div>
      <div className="w-96 m-3 p-5 border-4 rounded-full border-red-500">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, nobis.
      </div>
      <div className="w-96 m-3 p-5 border-4 rounded-t-2xl border-red-500">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, nobis.
      </div>
      <div className="w-96 m-3 p-5 border-4 rounded-b-2xl border-red-500">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, nobis.
      </div>

      {/* Outline */}
      <button className="w-12 ml-4 outline outline-4 outline-offset-2 outline-red-500">
        Click
      </button>
    </div>
  );
