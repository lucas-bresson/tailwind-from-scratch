export default function Page() {
  return (
    <div>
      {/* Width  */}
      <div className="bg-black text-white w-4">Hello world</div>
      ...
      <div className="bg-blue-500 text-white w-screen">Hello world</div>

      {/* 100% of container */}
      <div className="bg-blue-300 text-white w-full">Hello world</div>

      {/* Arbitrary width */}
      <div className="bg-blue-700 text-white w-[300px">Hello world</div>

      {/* Max Width */}
      <div className="bg-gray-300 max-w-lg mx-auto">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae
        reiciendis eveniet dicta? Ipsam obcaecati doloremque eum optio sit
        reiciendis illum eligendi vel, odit fugiat atque neque earum officia
        quis saepe.
      </div>
      ...
      {/* Full screen height */}
      <div className="bg-blue-300 text-white h-screen">
        Lorem ipsum dolor sit amet.
      </div>
    </div>
  );
